...
parser.add_argument(
    "--listen", type=str, default="127.0.0.1", metavar="IP", nargs="?", const="0.0.0.0", help=
...
parser.add_argument(
    "--enable-cors-header", type=str, default=None, metavar="ORIGIN", nargs="?", const="*",
...
parser.add_argument(
    "--dont-upcast-attention", action="store_true",
...
attn_group.add_argument(
    "--use-quad-cross-attention", action="store_true",
...
vram_group.add_argument(
    "--highvram", action="store_true", help=
...
parser.add_argument(
    "--windows-standalone-build", action="store_true", help=
