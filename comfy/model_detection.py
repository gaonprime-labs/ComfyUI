    ...
    for count in range(input_block_count):
        ...
        if "{}0.op.weight".format(prefix) in block_keys:  #new layer
            ...
            if res_block_prefix in block_keys:
                last_res_blocks += 1
                last_channel_mult = state_dict["{}0.out_layers.3.weight".format(
                    prefix)].shape[0]//model_channels
...
def unet_config_from_diffusers_unet(state_dict, dtype):
        ...
        for ab in range(attn_blocks):
            ...
            if transformer_count > 0:
                match["context_dim"] = state_dict[
                    "down_blocks.{}.attentions.{}.transformer_blocks.0.attn2.to_k.weight".format(i,
                                                                                                 ab)].shape[1]
    ...
    supported_models = [
        SDXL, SDXL_refiner, SD21, SD15, SD21_uncliph, SD21_unclipl, SDXL_mid_cnet, SDXL_small_cnet,
        SDXL_diffusers_inpaint, SSD_1B, Segmind_Vega
    ]
