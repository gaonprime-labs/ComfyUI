...
class V_PREDICTION(EPS):
    def calculate_denoised(self, sigma, model_output, model_input):
        ...
        return model_input*self.sigma_data**2/(
            sigma**2 + self.sigma_data**2) - model_output*sigma*self.sigma_data/(sigma**2 +
                                                                                 self.sigma_data**2)**0.5
...
class ModelSamplingDiscrete(torch.nn.Module):
    ...
    def _register_schedule(self, given_betas=None, beta_schedule="linear", timesteps=1000, linear_start=1e-4,
